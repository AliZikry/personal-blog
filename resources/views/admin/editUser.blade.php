                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            @endif
                            <form action="{{ route('adminEditUserPost' , ['id' => $user->id]) }}" method="POST">
                                {{--  {{ route('adminPostEditPost' , ['id' => $post->id]  )}}  --}}
                                @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                     ...
                                     <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            <input type="checkbox" id="author" name="author" value=1 {{ $user->author == true ? 'checked' : '' }} > <label for="author">Author</label>
                                            <br>
                                            <input type="checkbox" id="admin" name="admin" value=1 {{ $user->admin == true ? 'checked' : '' }} > <label for="admin">Admin</label>
                                            </div>
                                        </div>
                                    </div>
